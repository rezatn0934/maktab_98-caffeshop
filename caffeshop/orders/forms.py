...
class OrderForm(forms.ModelForm):
    table_number = forms.ModelChoiceField(label="Table Name:(if takeaway, skip this)",
            ...
            attrs={'class': 'form-control control-label m-0', 'style': 'font-size:14px;'}))
    ...
    class Meta:
        ...
        widgets = {"phone_number": forms.TextInput(
            attrs={"class": "form-control control-label m-0", 'placeholder': 'Phone number Should Start with 09',
